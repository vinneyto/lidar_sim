...
def load_gaussians(path: Path, default_scale: float = 0.01) -> Gaussians:
    """Load a PLY through the GaussForge Python API and normalize its tensors."""
    ...
    cloud = gaussforge.load_ply(str(path))
