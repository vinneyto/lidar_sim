...
def select_device(backend: str) -> torch.device:
    # TODO: проверьте backend и верните cpu или mps
...
def main() -> None:
    ...
    print(f"Backend: {BACKEND}; устройство: {device}")
    print(f"Сцена и BVH пока на CPU: {scene.means.device}, {bvh.bbox_min.device}")
